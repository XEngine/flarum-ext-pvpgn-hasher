...
class PVPGNHasher implements HasherContract{
    ...
    private static function get_hash($str) {
    ...
    public function make($value, array $options = [])
    {
        ...
        if ($hash === false) {
            throw new RuntimeException('PVPGN hashing not supported.');
        }
        return $hash;
    }
    ...
    public function check($value, $hashedValue, array $options = [])
    {
        ...
        return self::get_hash($value) === $hashedValue ? true : false;
    }
    ...
    {
        //never will be used I guess..
        return self::get_hash($hashedValue);
    }
